...
import ArrowUpIcon from '@/assets/imgs/arrow-down.png'
  ...
  render() {
    ...
    return (
      <View className='progress-list'>
        <View className='order-title'>{this.handleTypeText}</View>
        <View className='list-item'>
          <View className='header'>
            ...
            <Image src={ArrowUpIcon} className='header-arrow' />
          </View>
                  ...
                  progressList.map((item, index) => {
                    return (
                      <View key={item.title} className='progress-item'>
                        ...
                        {index == 1 && (
                          <Image src={IndicatorIcon} className='progress-item__icon' />
                        )}
